...
void ars_Init(struct ars_Gyro1DKalman *filterdata, double Q_angle,
              double Q_gyro, double R_angle);

// Kalman predict
void ars_predict(struct ars_Gyro1DKalman *filterdata, const double gyro,
                 const double dt);
